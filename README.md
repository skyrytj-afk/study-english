...
### 4) 대화 (선택)
- 레슨 주제로 AI와 짧고 쉬운 영어 자유 대화 (**응답 실시간 스트리밍**)
...
└─ api/
   ...
   ├─ chat/route.ts     자유 대화 (스트리밍)
   └─ word/route.ts     단어 뜻 조회
components/
...
├─ textScore.ts         발음 점수 채점
├─ wordLookup.ts        단어 뜻 조회·캐시
